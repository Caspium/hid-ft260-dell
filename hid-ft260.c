...
static const struct hid_device_id ft260_devices[] = {
	{HID_USB_DEVICE(USB_VENDOR_ID_DELL,
					USB_DEVICE_ID_DELL_eRDHx_Hub)},
	{HID_USB_DEVICE(USB_VENDOR_ID_DELL,
					USB_DEVICE_ID_DELL_eRDHx_Fans)},
	{HID_USB_DEVICE(USB_VENDOR_ID_DELL,
					USB_DEVICE_ID_DELL_eRDHx_LCD)},
	{HID_USB_DEVICE(USB_VENDOR_ID_DELL,
					USB_DEVICE_ID_DELL_eRDHx_Light)},
	{HID_USB_DEVICE(USB_VENDOR_ID_DELL,
					USB_DEVICE_ID_DELL_eRDHx_Temp)},
	{/* END OF LIST */}};
								   ...
								   struct ktermios *old)
{
	...
	req.stop_bit = (termios->c_cflag & CSTOPB) ? FT260_UART_CFG_STOP_TWO_BIT : FT260_UART_CFG_STOP_ONE_BIT;

	if (termios->c_cflag & PARENB)
	{
		req.parity = (termios->c_cflag & PARODD) ? FT260_UART_CFG_PAR_ODD : FT260_UART_CFG_PAR_EVEN;
	}
	else
	{
